...
export default function SertifikatSettingPage1() {
  return (
      ...
      <div className="flex w-full items-center justify-center mt-6 font-cambria">
        <table>
          <tr>
            <td width={30}>Nama </td>
            <td width={30}>: </td>
            <td className="font-black">XXXXXXXXXXXX</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width={30}>: </td>
            <td className="text-bold">XXXXXXXXXXXXXX</td>
          </tr>
        </table>
      </div>
      ...
      <div className="flex gap-2 items-center justify-end mt-5">
        <div className="flex flex-col font-cambria text-center items-center justify-center">
          <input
            id="name"
            type="text"
            className="form-input w-full mb-2 text-black border-gray-300 rounded-md"
            placeholder="Banyuwangi, 27 Januari 2024"
            required
          />
          <p className="-mt-1">
