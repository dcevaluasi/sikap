  ...
  return (
    <div className="h-screen w-full flex overflow-hidden antialiased text-gray-800 bg-white">
      ...
      <nav
        ...
        className="flex-none flex flex-col items-center text-center bg-blue-950 text-gray-400 border-r"
      >
        <div className="h-16 flex items-center w-full">
          <Image
            width={0}
            height={0}
            alt="Dewan Penguji Awak Kapal Perikanan"
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-grow flex min-h-0 border-t  h-full overflow-y-scroll overflow-x-scroll">
          ...
          <section className="flex flex-col p-4 w-full max-w-sm flex-none bg-gray-100 min-h-0 overflow-auto">
            <h1 className="font-semibold mb-3">Ujian Sedang Berlangsung</h1>
            <ul>
              <li>
                <article
                  tabIndex={0}
