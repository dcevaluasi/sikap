  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/" className="flex gap-2 mt-8 flex-col items-center justify-center">
          <Image
            width={100}
            height={0}
            src={"/logo-elaut.png"}
          ...
          <div className="flex flex-col gap-1 w-full items-center justify-center">
            ...
            <p className="font-medium text-white text-sm text-center">Elektronik Layanan Pelatihan Umum Terpadu BPPSDM KP</p>
          </div>
        </Link>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear -mt-5">
        {/* <!-- Sidebar Menu --> */}
