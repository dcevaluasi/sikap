...
import { dpkakpBaseUrl, elautBaseUrl } from "@/constants/urls";
import { UserInformationDPKAKP } from "@/types/dpkakp";
const DropdownUserDPKAKP = ({
  userLoggedInInfo,
  dpkakpLoggedInfo,
}: {
  userLoggedInInfo?: LemdiklatDetailInfo | null;
  dpkakpLoggedInfo?: UserInformationDPKAKP | null;
}) => {
  ...
  const [dataAdminPusat, setDataAdminPusat] =
      ...
      >
        <span className="hidden text-right lg:block">
          <span className="block text-sm font-medium text-black">
            {dpkakpLoggedInfo != null ? dpkakpLoggedInfo!.Email : ""}
          </span>
          <span className="block text-xs">
            {dpkakpLoggedInfo != null ? dpkakpLoggedInfo!.Nama : ""}
          </span>
        </span>
...
export default DropdownUserDPKAKP;
