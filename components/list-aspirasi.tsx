...
const CardPelatihan = ({ pelatihan }: { pelatihan: Pelatihan }) => {
  return (
    <div className="coverflow flex flex-col shadow-custom relative w-[360px] h-fit rounded-3xl bg-gray-700">
      ...
      <Image
        ...
        height={0}
      />
      <div className="px-6 py-3 rounded-bl-3xl rounded-br-3xl bg-white">
