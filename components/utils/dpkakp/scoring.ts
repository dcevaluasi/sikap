...
import { EXAM_THRESHOLD, PRACTICE_WEIGHT, THEORY_WEIGHT } from "@/constants/globals";
...
export function exportToExcelFinalScoring({ dataUjian, data }: { dataUjian: Ujian[]; data: UsersUjian[] }) {
