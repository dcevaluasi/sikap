  ...
  return (<section className="flex flex-row gap-3 w-full items-center max-w-6xl mb-5 px-3 mx-auto">
    <Select>
      <SelectTrigger className="w-fit rounded-3xl py-2">
        <p className="mr-3 flex items-center gap-1 text-sm"><FiSlack />Pilih Bidang Pelatihan</p>
      </SelectTrigger>
      <SelectContent>
        <SelectGroup>
    ...
    <div className="relative w-full flex items-center border-black border px-2 rounded-3xl">
      ...
      <Input className="text-sm border-none -ml-1 focus:border-none active:outline-none active:border-none focus:outline-none focus-visible:ring-0" placeholder="Cari Pelatihan" />
    </div>
  </section >)
}
