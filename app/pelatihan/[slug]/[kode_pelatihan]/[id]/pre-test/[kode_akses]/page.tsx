...
function Page() {
    ...
    return (
        <section className={`w-full h-screen ${doCheating ? 'bg-rose-500' : 'bg-gray-900'} grid items-center justify-center text-white relative`}>
            {
                doCheating ? <div className="w-fit flex flex-col items-center justify-center gap-2 max-w-md mx-auto text-center">
                    ...
                    <div className="absolute w-fit flex gap-2 top-5 right-5 text-4xl font-medium text-white items-center">
                        <TbClock />
