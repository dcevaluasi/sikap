...
function page() {
    ...
    return (
        <main className='bg-darkDPKAKP w-full h-full'>
            <section className="relative h-fit space-y-6 pb-8 pt-36 md:h-screen md:pb-12 md:pt-20 lg:py-44 w-full flex items-center justify-center">
                <div className="container relative flex max-w-[64rem] flex-col items-center gap-4 text-center">
                    ...
                    <h1 className="font-bold text-gray-200 text-4xl sm:text-5xl md:text-6xl lg:text-7xl">
                        Dewan Penguji Keahlian Awak Kapal Perikanan
                    </h1>
                    <p className="font-jakarta max-w-[47rem] leading-[100%] text-mutedForegroundDPKAKP  sm:text-xl sm:leading-8 ">
                        Berdasarkan{" "}
                        <span className="font-bold">Permen KP 33 Tahun 2021</span> Tentang
                        Logbook Penangkapan Ikan, Pemantauan Di atas Kapal Penangkap Ikan
                        dan Kapal Pengangkut Ikan, Inspeksi, Pengujian, dan Penandaan Kapal
                        Perikanan, serta Tata Kelola Pengawasan Kapal Perikanan.
                    </p>
                    <Image
                        className="absolute -top-28 w-[500px] opacity-10"
                        src={"/dpkakp/logo.png"}
                        width={0}
                        height={0}
                        alt="DPKAKP Logo"
            ...
            <section className="mb-10 -mt-8 h-fit w-full px-5 py-4 ">
                <Marquee>
                    ...
                    <Image
                        className="mr-16 w-[60px] opacity-10"
                        src={"./dpkakp/logo.png"}
                        width={0}
                        height={0}
                        alt="DPKAKP Logo"
            ...
            <section
                id="dasarHukum"
                className="container flex flex-col items-center justify-center gap-6 py-8 md:max-w-[64rem] md:py-12 lg:py-24 mx-auto"
            >
                <div className="mx-auto flex w-full flex-col gap-4 md:max-w-[58rem]">
                    <h2 className="items-center justify-center text-center font-heading text-3xl leading-[1.1] sm:text-5xl md:text-5xl text-gray-200 font-bold">
                        Dasar Hukum Peraturan <br /> Nasional & Internasional
                    </h2>
                ...
                <div className="grid w-full items-start gap-10 rounded-lg border border-mutedDPKAKP  p-10 ">
                    <div className="grid gap-6">
                        <h3 className="text-xl font-bold sm:text-2xl text-gray-200">
                            Peraturan yang mengatur
                        </h3>
                        <ul className="grid gap-3 text-sm text-mutedForegroundDPKAKP sm:grid-cols-2">
                            <li className="flex items-center">
                                <CheckCircle2Icon className="mr-2 h-4 w-4" /> UU No. 45 Tahun 2009
                                junto UU No 31 Tahun 2004 Tentang Perikanan;
                            </li>
                            <li className="flex items-center">
                                <CheckCircle2Icon className="mr-2 h-4 w-4" /> PP No. 62 Tahun 2014
                                tentang Penyelenggaraan Pendidikan, Pelatihan, dan Penyuluhan
                                KP;
                            </li>

                            <li className="flex items-center">
                                <CheckCircle2Icon className="mr-2 h-4 w-4" /> PP No. 27 Tahun 2021
                                tentang Penyelenggaraan Kelautan dan Perikanan;
                            </li>
                            <li className="flex items-center">
                                <CheckCircle2Icon className="mr-2 h-4 w-4" /> Perpres No. 2 Tahun
                                2017 tentang Perubahan atas Perpres No. 63 Tahun 2015 tentang
                                Kementerian Kelautan dan Perikanan;
                            </li>
                            <li className="flex items-center">
                                <CheckCircle2Icon className="mr-2 h-4 w-4" /> Perpres No. 18 Tahun
                                2019 tentang Pengesahan Konvensi Internasional STCW-F 1995;
                            </li>
                            <li className="flex items-center">
                                <CheckCircle2Icon className="mr-2 h-4 w-4" /> Permen KP No. 48 Tahun
                                2020 tentang Organisasi dan Tata Kerja Kementerian Kelautan dan
                                Perikanan;
                            </li>
                            <li className="flex items-center">
                                <CheckCircle2Icon className="mr-2 h-8 w-8" /> Permen KP No. 33 Tahun
                                2021 tentang Logbook Penangkapan Ikan dan Kapal Pengangkut Ikan,
                                Inspeksi Pengujian, dan Penandaan Kapal Perikanan, serta Tata
                                Kelola Pengawakan Kapal Perikanan;
                            </li>
                            <li className="flex items-center">
                                <CheckCircle2Icon className="mr-2 h-4 w-4" /> Keputusan Dirjen
                                Perikanan Tangkap No. 56 Tahun 2022 tentang Dewan Penguji
            ...
            >
                <div className="mx-auto flex w-full flex-col gap-4 ">
                    ...
                    <p className="w-full text-center leading-normal text-mutedForegroundDPKAKP sm:text-lg sm:leading-7">
                        Mengenal lebih jauh tugas, visi & misi, serta struktur organisasi
                        DPKAP
                    </p>
                </div>
                <Swiper
