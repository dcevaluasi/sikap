          ...
          <div className="grid gap-6">
            ...
            <ul className="grid gap-3 text-sm text-mutedForegroundDPKAKP sm:grid-cols-2">
              <li className="flex items-center">
                <CheckCircle2Icon className="mr-2 h-4 w-4" /> UU No. 45 Tahun
                2009 junto UU No 31 Tahun 2004 Tentang Perikanan;
              </li>
              <li className="flex items-center">
                <CheckCircle2Icon className="mr-2 h-4 w-4" /> PP No. 62 Tahun
                2014 tentang Penyelenggaraan Pendidikan, Pelatihan, dan
                Penyuluhan KP;
              </li>

              <li className="flex items-center">
                <CheckCircle2Icon className="mr-2 h-4 w-4" /> PP No. 27 Tahun
                2021 tentang Penyelenggaraan Kelautan dan Perikanan;
              </li>
              <li className="flex items-center">
                <CheckCircle2Icon className="mr-2 h-4 w-4" /> Perpres No. 2
                Tahun 2017 tentang Perubahan atas Perpres No. 63 Tahun 2015
                tentang Kementerian Kelautan dan Perikanan;
              </li>
              <li className="flex items-center">
                <CheckCircle2Icon className="mr-2 h-4 w-4" /> Perpres No. 18
                Tahun 2019 tentang Pengesahan Konvensi Internasional STCW-F
                1995;
              </li>
              <li className="flex items-center">
                <CheckCircle2Icon className="mr-2 h-4 w-4" /> Permen KP No. 48
                Tahun 2020 tentang Organisasi dan Tata Kerja Kementerian
                Kelautan dan Perikanan;
              </li>
              <li className="flex items-center">
                <CheckCircle2Icon className="mr-2 h-8 w-8" /> Permen KP No. 33
                Tahun 2021 tentang Logbook Penangkapan Ikan dan Kapal Pengangkut
                Ikan, Inspeksi Pengujian, dan Penandaan Kapal Perikanan, serta
