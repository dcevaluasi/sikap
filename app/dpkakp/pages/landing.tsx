    ...
    <main className="bg-darkDPKAKP w-full h-full">
      {loading ? (
        ...
        <>
          ...
          <section
            id="dasarHukum"
            className=" flex flex-col items-center justify-center gap-6 py-8 md:max-w-[64rem] md:py-12 lg:py-24 mx-auto"
          >
            <div className="mx-auto flex w-full flex-col gap-4 md:max-w-[58rem]">
              ...
              <p className="w-full text-center leading-normal text-mutedForegroundDPKAKP sm:text-lg sm:leading-7 ">
                UU, PP, Perpres, dan Permen yang menjadi dasar terbentuknya
                DKPAKP
              </p>
            </div>
              ...
              <div className="grid gap-6">
                ...
                <ul className="grid gap-3 text-sm text-mutedForegroundDPKAKP sm:grid-cols-2">
                  <li className="flex items-center">
                    <CheckCircle2Icon className="mr-2 h-4 w-4" /> UU No. 45
                    Tahun 2009 junto UU No 31 Tahun 2004 Tentang Perikanan;
                  </li>
                  <li className="flex items-center">
                    <CheckCircle2Icon className="mr-2 h-4 w-4" /> PP No. 62
                    Tahun 2014 tentang Penyelenggaraan Pendidikan, Pelatihan,
                    dan Penyuluhan KP;
                  </li>

                  <li className="flex items-center">
                    <CheckCircle2Icon className="mr-2 h-4 w-4" /> PP No. 27
                    Tahun 2021 tentang Penyelenggaraan Kelautan dan Perikanan;
                  </li>
                  <li className="flex items-center">
                  ...
                  <li className="flex items-center">
                    <CheckCircle2Icon className="mr-2 h-4 w-4" /> Permen KP No.
                    48 Tahun 2020 tentang Organisasi dan Tata Kerja Kementerian
                    Kelautan dan Perikanan;
                  </li>
                  <li className="flex items-center">
                    <CheckCircle2Icon className="mr-2 h-8 w-8" /> Permen KP No.
                    33 Tahun 2021 tentang Logbook Penangkapan Ikan dan Kapal
                    Pengangkut Ikan, Inspeksi Pengujian, dan Penandaan Kapal
                    Perikanan, serta Tata Kelola Pengawakan Kapal Perikanan;
                  </li>
                  <li className="flex items-center">
                    <CheckCircle2Icon className="mr-2 h-4 w-4" /> Keputusan
                    Dirjen Perikanan Tangkap No. 56 Tahun 2022 tentang Dewan
